...
export default function EventDialog({
  open, onOpenChange, selectedDate, editingEvent, onSave, onDelete,
}: Props) {
  ...
  useEffect(() => {
    if (editingEvent) {
      ...
      setTitle(""); setIsAllDay(true); setStartTime("10:00");
      setEndTime("11:00"); setColor(COLOR_OPTIONS[0]);
      setCalendarId("personal"); setDescription("");
    }
  }, [editingEvent, open]);
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <Input
              id="title" value={title} autoFocus
